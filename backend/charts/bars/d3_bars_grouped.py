...
def add_d3_bars_grouped_option(response, chart, df, color):
...
def add_d3_bars_grouped_description(response, chart, df, color, template):
    add_L1_description(response, chart, template['L1-info'])
    template = template['d3-bars-grouped']
